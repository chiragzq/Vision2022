...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [61.510791366906474, 92.90322580645163]
        self.__hsv_threshold_saturation = [150.83093525179854, 255.0]
        self.__hsv_threshold_value = [120.67446043165468, 255.0]

        self.hsv_threshold_output = None

        self.__blur_input = self.hsv_threshold_output
        self.__blur_type = BlurType.Gaussian_Blur
        self.__blur_radius = 1.8018018018018
        ...
        self.__filter_contours_solidity = [92.53597122302158, 100.0]
    ...
    def __find_contours(input, external_only):
        ...
        # print(cv2.findContours(input, mode=mode, method=method))
